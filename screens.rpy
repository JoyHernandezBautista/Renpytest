...
#         xalign 0.5
#         yalign 0.5
#         text "En un mundo contemporáneo altamente tecnológico, donde la información es poder y la seguridad cibernética es una preocupación prioritaria para los gobiernos."
#         text "Dos personalidades se enfrentan en una lucha por la supervivencia."
#         textbutton "Pixel" action Jump("pixel_start")
#         textbutton "Alberto" action Jump("alberto_start")
